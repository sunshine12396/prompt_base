...
|-----------|-------|-------|
| 🤖 **Specialist Agents** | 19 | Role-based personas (Frontend, Security, DevOps, etc.) |
...
The fastest way to inject Prompt Base into your project:
...
|----------|---------|----------|
| **Antigravity** | 🟢 Native | Direct integration with Agentic workflows. |
| **Cursor** | 🟢 Native | Uses `.cursorrules` (auto-configured). |
| **VS Code** | 🟡 High | Optimized for Copilot, Cline, and Roo Code. |
| **JetBrains** | 🟡 Medium | Requires manual context attachment. |

---

## 📊 Core Standards (Pro Max)
...
*   🔌 **[Integration Guide](docs/INTEGRATION.md)**: Setup instructions for all major IDEs.
